...
public class DashboardStepDefinitions extends CommonMethods {
	...
	public void verify_the_following_dashboard_tabs(DataTable dashboardTabs) {// converting to list
		List<String> expectedDashtabs = dashboardTabs.asList(); // converting to list
